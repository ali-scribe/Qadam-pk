...
- **AI evidence extraction is not perfect** — Although this error has not happened yet, Gemini might paraphrase rather than quoting verbatim excerpts. See `demo/known-limitations.md` for any specific examples observed during testing.
